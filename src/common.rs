...
pub mod test {
    ...
    /// Now it requires passing a secret_key, and combining that with a 32-byte random fill
    ///
    /// So a reasonable test would be to call the seeded RNG two times to construct
