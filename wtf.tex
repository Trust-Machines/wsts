...
The WTF reference implementation \cite{tmfrost} contains vanilla FROST in the v1 module, and WTF in the v2 module.  This crate contains criterion benchmarks for both v1 and v2.

The results are quite staggering.  When testing DKG with $4$ signers and $20$ keys, v2 outperforms v1 by an order of magnitude: $53.793 ms$ per DKG round for v1 compared to $8.2657 ms$ for v2.
